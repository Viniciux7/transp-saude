 ...
 *
 * Campos: nome, CPF, data de nascimento e senha.
 * Salva no SQLite local via userService.
 *
 * Conceitos novos aqui:
 *   - Máscaras de CPF e data aplicadas enquanto o usuário digita
 *   - Validação de CPF com algoritmo dos dígitos verificadores
 *   - Validação de data real (rejeita 30/02, por exemplo)
 */
...
//
// Colocamos fora do componente porque não dependem de estado.
// Isso evita que sejam recriadas a cada re-renderização.
// ─────────────────────────────────────────────────────────────
 ...
 * Usa o objeto Date do JavaScript para verificar se a data realmente existe.
 */
...
export default function CadastroScreen() {
  ...
  const handleCadastro = () => {
    ...
    // Chama o userService para inserir no banco
    ...
    // Cadastro OK → avisa o usuário e manda para o login
    Alert.alert(
      'Cadastro realizado!',
